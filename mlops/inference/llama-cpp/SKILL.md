...
- **[hermes-auxiliary.md](references/hermes-auxiliary.md)** — configuring Hermes Agent auxiliary tasks (vision, compression, approval, curator, etc.) to use a local llama-server as the backend model
